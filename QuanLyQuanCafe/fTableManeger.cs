...
namespace QuanLyQuanCafe
{
    public partial class fTableManeger : Form
    {
        ...
        private IEnumerable<Table> tableList;
        ...
        {
            fAccountProfie f = new fAccountProfie(loginAccount);
            f.ShowDialog();
        }
        ...
        private void btnCheckOut_Click(object sender, EventArgs e)
        {
            ...
            if(idBill != -1)
            {
                if (MessageBox.Show(string.Format("Bạn muốn thanh toán {0}\n Tổng tiền = {1}", table.Name + "?", finalTotalPrice + "000"), "Thông báo", MessageBoxButtons.OKCancel) == System.Windows.Forms.DialogResult.OK)
                {
